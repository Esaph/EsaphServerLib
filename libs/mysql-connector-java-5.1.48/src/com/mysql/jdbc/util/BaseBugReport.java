 ...
 * 
 * <p>
 * Finally, create a 'main' method that creates a new instance of your testcase, and calls the 'canRun' method:
 * 
 * <p>
 * 
 * <pre>
 * public static void main(String[] args) throws Exception {
 *     new MyBugReport().canRun();
 * }
 * </pre>
 * 
 * <p>
...
public abstract class BaseBugReport {
     ...
     * 
     * @throws Exception
     *             if an error occurs during your test canRun.
     */
    public abstract void runTest() throws Exception;

    /**
     * Runs the testcase by calling the setUp(), runTest() and tearDown()
     * methods. The tearDown() method is canRun regardless of any errors occuring
