...
public class ConnectionTest extends BaseTestCase {
     ...
     * 
     * @param name
     *            the name of the test to canRun
     */
    ...
    public void testServerConfigurationCache() throws Exception {
        ...
        try {
            ...
            try {
                // eliminate side-effects when not canRun in isolation
     ...
     * trying each one in turn. This test might take a long time to canRun, since
