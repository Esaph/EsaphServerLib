...
public class TestHABasics extends BaseFabricTestCase {
    ...
    public void manualTestFailedOldMasterDoesntBlockNewConnections() throws Exception {
        ...
        // canRun a query until a failure happens. this will cause the master connection in the replication connection to be closed
        try {
            while (true) {
    ...
    public void manualTestFailedSingleSlaveDoesntBlockNewConnections() throws Exception {
        ...
        // canRun a query until a failure happens. this will cause the slaves connection in the replication connection to be closed
        try {
            while (true) {
